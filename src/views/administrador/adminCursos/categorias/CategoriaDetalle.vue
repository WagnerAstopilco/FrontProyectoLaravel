                    ...
                    <table id="courseCategoryTable" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center d-none d-md-table-cell">Abreviación</th>
                        ...
                        <tbody>
                            <tr v-for="course in category.courses" :key="course.id">
                                ...
                                <td class="d-none d-md-table-cell">{{ course.name_short }}</td>
                                <td >{{ course.description }}</td>
                                <td><button type="button" class="btn btn-outline-danger" @click="goToEditCourse(course.id)">
