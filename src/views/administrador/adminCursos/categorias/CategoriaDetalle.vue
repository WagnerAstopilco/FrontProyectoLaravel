    ...
    <div class="card p-4">
        <div class="head d-flex">
            ...
            <div class="dropdown ms-auto" >
                <button class="btn btn-secondary dropdown-toggle ms auto" style="background-color:rgb(29,29,27);color:white;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Opciones 
                </button>
            ...
            <div v-if="category">
                <form @submit.prevent="updateCategory" class="w-50">
                    ...
                    <div v-if="isEditing ">
                        <button type="submit" class="btn  m-2" style="background-color:rgb(88,176,49);color:white">{{ loading ? "Actualizando..." : "Actualizar" }}</button>
                        <button type="button" class="btn  m-2" style="background-color:rgb(0,87,163);color:white;" @click="cancelEdit">Cancelar</button>
                    </div>
                </form>
                <div class="courses">
                        ...
                        <table id="courseCategoryTable" class="table">
                            ...
                            <tbody>
                                <tr v-for="course in category.courses" :key="course.id">
                                    ...
                                    <td><button type="button" class="btn btn-outline-danger" @click="editCourse(course.id)">
        ...
        <div class="volver mx-auto">
            <button type="button" class="btn btn-primary" style="background-color:rgb(0,87,163);color:white;" @click="goBack">Volver</button>
        </div>
    </div>
</div>
</template>
